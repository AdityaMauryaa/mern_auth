...
const ResetPassword = () => {
    ...
    const [isOptSubmitted,setIsOptSubmitted]=useState('')
    ...
    const onSubmitEmail=async (e)=>{
        ...
        try {
            ...
            toast.error("onSubmitEmail "+error.message)
        }
    }
    ...
    const onSubmitNewPassword= async (e)=>{
        ...
        try {
            ...
            data.success ? toast.success(data.message):toast.error('1+'+data.message)
  ...
  return (
    ...
    {!isEmailSent  && 
      ...
      to-indigo-900 rounded-full mt-3'>Submit</button>
      </form>
    }
        {   
        ...
        { isOptSubmitted && isEmailSent &&
            <form onSubmit={onSubmitNewPassword} className='bg-slate-900 p-8 rounded-lg shadow-lg w-96 text-sm'>
                ...
                rounded-full bg-[#333A5C]'>
                    ...
                    <input type="password"  placeholder='Enter new password' className='bg-transparent text-white outline-none'
