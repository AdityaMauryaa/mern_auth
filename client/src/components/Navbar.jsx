    ...
    <div className='w-full flex justify-between items-center p-4 sm:p-6 sm:px-24 absolute top-0' >
      ...
      bg-black text-white relative group'>
        ...
        z-10 text-black rounded pt-10'>
            ...
            text-sm'>
                {!userData.isAccountVerified &&  <li onClick={sendVerificationOtp} className='py-1 px-2 text-red-900 text-xl hover:bg-gray-200 cursor-pointer'>Verify Email !!</li>}
      ...
      className='flex items-center gap-2 border border-gray-500
       ...
       transition-all'>Register / Login <img src={assets.arrow_icon} alt="" /></button>
    }
